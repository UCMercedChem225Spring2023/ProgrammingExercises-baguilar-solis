...
!      Call diagonalize_hMatrix(hMatrix,NBasis)
!
!     The end of the job...
!
  999 continue
...
!      Subroutine diagonalize_hMatrix(hmatrix,matrix_dim,EVecs,EVals,Temp_Vector)

!     Variable Declarations

!      implicit none
!      integer,intent(in)::matrix_dim   
!      real,dimension(matrix_dim,matrix_dim),intent(in)::hmatrix
!      real,dimension((matrix_dim*(matrix_dim+1))/2)::packed_hmatrix
!      real,dimension(:),allocatable::EVals,Temp_Vector
!      real,dimension(:,:),allocatable::EVecs
!      integer::i,j,k,IError

!     Convert hmatrix to lower-col packed form 
...
!      write(*,*)'Packed H Matrix:'
!      write(*,'(f5.1)') packed_hmatrix

!     Allocate dimesions to evecs.evals. and temp_vec

!      Allocate(EVals(matrix_dim),EVecs(matrix_dim,matrix_dim),&
!        Temp_Vector(3*matrix_dim))


!     Diagonalize hmatrix 

!      Call SSPEV('V','L',matrix_dim,packed_hmatrix,EVals,EVecs,&
!        matrix_dim,Temp_Vector,IError)
...
!      write(*,*) 'Evals: '
!      Call Print_Matrix_Full_Real(RESHAPE(Evals,(/1,matrix_dim/)),1,&
!        matrix_dim)

!      write(*,*) 'Evecs: '
!      Call Print_Matrix_Full_Real(Evecs,matrix_dim,matrix_dim)

!     end Subroutine diagonalize_hMatrix
...
!
      ...
      Subroutine wavefunction(evecs,l)
